...
<div class="main-cont">
	...
	<div class="main-cont-form">
		<form action="" method="post"  id="baseDistributorForm">
			<input type="hidden" name="baseDistributor.id" id="id" value="${baseDistributor.id}"/>
			<div class="main-cont-form-group">
				<label>商户号：</label>
				<span>${baseDistributor.companyNumber}</span>
				<input type="hidden" name="baseDistributor.companyNumber" id="companyNumber" value="${baseDistributor.companyNumber}"/>
			</div>
			<div class="main-cont-form-group">
				<label>公司名称：</label>
				<input type="text" name="baseDistributor.companyName" id="companyName" value="${baseDistributor.companyName}" placeholder="请输入公司全称" />
			</div>
			<div class="main-cont-form-group">
				<label>法人名称：</label>
				<input type="text" name="baseDistributor.legalPerson" id="legalPerson" value="${baseDistributor.legalPerson}" placeholder="请输入法人名称" />
			</div>
			<div class="main-cont-form-group">
				<label>公司地址：</label>
				<input type="text" name="baseDistributor.companyAddress" id="companyAddress" value="${baseDistributor.companyAddress}" placeholder="请输入公司地址" />
			</div>
			<div class="main-cont-form-group">
				<label>公司电话：</label>
				<input type="text" name="baseDistributor.companyTelephone" id="companyTelephone" value="${baseDistributor.companyTelephone}" placeholder="请输入公司电话" />
			</div>
			<div class="main-cont-form-group">
				<label>开户行：</label>
				<input type="text" name="baseDistributor.companyBankAddress" id="companyBankAddress" value="${baseDistributor.companyBankAddress}" placeholder="请输入开户行" />
			</div>
			<div class="main-cont-form-group">
				<label>开户行账号：</label>
				<input type="text" name="baseDistributor.companyBankAccount" id="companyBankAccount" value="${baseDistributor.companyBankAccount}" placeholder="请输入开户行账号" />
			</div>
			<div class="main-cont-form-group">
				<label>公司邮箱：</label>
				<input type="text" name="baseDistributor.companyEmail" id="companyEmail" value="${baseDistributor.companyEmail}" placeholder="请输入公司邮箱" />
			</div>
			<div class="main-cont-form-group">
				<label>公司传真：</label>
				<input type="text" name="baseDistributor.companyFax" id="companyFax" value="${baseDistributor.companyFax}" placeholder="请输入公司传真" />
			</div>
			<div class="main-cont-form-group">
				<label>联系人：</label>
				<input type="text" name="baseDistributor.companyPerson1" id="companyPerson1" value="${baseDistributor.companyPerson1}" placeholder="请输入公司联系人" />
			</div>
			<div class="main-cont-form-group">
				<label>联系人电话：</label>
				<input type="text" name="baseDistributor.companyPerson1Telephone" id="companyPerson1Telephone" value="${baseDistributor.companyPerson1Telephone}" placeholder="请输入公司联系人电话" />
			</div>
			<div class="main-cont-form-group">
				<label>联系人邮箱：</label>
				<input type="text" name="baseDistributor.companyPerson1Email" id="companyPerson1Email" value="${baseDistributor.companyPerson1Email}" placeholder="请输入公司联系人邮箱" />
			</div>
			<div class="main-cont-form-group">
				<label>行业名称：</label>
				<input type="text" name="baseDistributor.tradeName" id="tradeName" value="${baseDistributor.tradeName}" placeholder="请输入公司行业" />
			</div>
			<div class="main-cont-form-group">
				<label>三证合一副本：</label>
				<div class="upload">
					<input type="file" name="baseDistributor.threeinoneLicencePic" id="threeinoneLicencePic" value="${baseDistributor.threeinoneLicencePic}" class="upload_input"/>
				</div>
			</div>
			<div class="main-cont-form-group">
				<label>法人身份证照片正面：</label>
				<div class="upload">
					<input type="file" name="baseDistributor.legalPersonIdCardPicAhead" id="legalPersonIdCardPicAhead" value="${baseDistributor.legalPersonIdCardPicAhead}" class="upload_input"/>
				</div>
			</div>
			<div class="main-cont-form-group">
				<label>法人身份证照片反面：</label>
				<div class="upload">
					<input type="file" name="baseDistributor.legalPersonIdCardPicBack" id="legalPersonIdCardPicBack" value="${baseDistributor.legalPersonIdCardPicBack}" class="upload_input"/>
				</div>
			</div>
			<div class="main-cont-form-group">
				<label>行业经营许可证图片：</label>
				<div class="upload">
					<input type="file" name="baseDistributor.tradeLicencePic" id="tradeLicencePic" value="${baseDistributor.legalPersonIdCardPicBack}" class="upload_input"/>
				</div>
			</div>
			<div class="button">
				<button class="btn submit" type="submit">提交审核</button>
				<button class="btn" id="cancelBtn">返回</button>
			</div>
		</form>
	</div>
</div>
...
<script type="text/javascript">
	$(document).ready(
			function(){
				...
				$('#baseDistributorForm').on("click", ".doSubmit",
						function(e){
							...
							valid: function(form){
								...
								me.holdSubmit();
								$.ajax({
									url:"${ contextpath}/distributor/update",
									data: $(form).serialize(),
									type: "POST",
